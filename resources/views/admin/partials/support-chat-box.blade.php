            ...
            <div class="col-md-6">
                <div class="card card-bordered">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-sm-6">
                                    <h5><strong>Support Chat</strong></h5>
                            </div>
                            <div class="col-sm-6 text-right">
                                <i class="fas fa-window-close" role="button" id="closeChatBtn"></i>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="publisher bt-1 border-light"> <img class="avatar avatar-xs"
                            ...
                            id="messageInput"
                            class="publisher-input" type="text" placeholder="Write something">   <a id="sendMessgeBtn" class="publisher-btn text-info" href="#"
                            data-abc="true"><i class="fa fa-paper-plane" ></i></a> </div>
                </div>
            </div>
        </div>
    </div>
